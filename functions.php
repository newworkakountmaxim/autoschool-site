...
function autoschool_mariupol_scripts() {
    ...
    wp_enqueue_style( 'remodal-theme',  get_template_directory_uri() . '/css/remodal-default-theme.css' );
    ...
    wp_enqueue_script( 'remodal-js', get_template_directory_uri() . '/js/remodal.js', array( 'jquery' ), '20191215', true );
